		...
		paths: {
			["/"]: {
				post: {
					...
					tags: [],
					description: `현재 네트워크에서 활성화된 검증자의 목록을 반환합니다. 이 메소드는 네트워크의 현재 검증자들을 식별하는 데 사용되며, 네트워크의 거버넌스와 보안 상태를 이해하는 데 중요한 정보를 제공합니다. 검증자 목록은 네트워크의 합의 프로토콜과 거버넌스 메커니즘에 따라 변경될 수 있으며, 이 메소드를 통해 현재 활성화된 검증자들을 조회할 수 있습니다.`,
					summary: method,

...
const tableHandlePathParam = {
	...
	schema: {
		...
		default: "0x1b854694ae746cdbd8d44186ca4929b2b337df21d1c74633be19b2710552fdca", // 새로운 default 값 추가
	},
};
...
const info: OpenAPIV3.PathItemObject = {
	post: {
		...
		summary,
		operationId,
		parameters: [Requests.Headers.acceptBSC, tableHandlePathParam, Requests.QueryParams.ledgerVersion],
		requestBody: {
			required: true,
			content: {
				"application/json": {
						...
						allOf: [
							{
								...
								properties: {
									key: {
										...
										default: "0x0619dc29a0aac8fa146714058e8dd6d2d0f3bdf5f6331907bf91f3acd81e6935",
									},
								},
							},
						],
